...
class USRNet(nn.Module):
    def __init__(self, n_iter=1, h_nc=64, in_nc=4, out_nc=3, nc=[64, 128, 256, 512], nb=2, act_mode='BR', downsample_mode='strideconv', upsample_mode='convtranspose'):
