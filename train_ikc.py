        ...
        for _, train_data in enumerate(train_loader):
           ...
           #HFA
            ...
            # est_ker_map=util.single2tensor4(est_ker_map[..., np.newaxis]).to(device)
                ...
                model_C.feed_data(SR_img, est_ker_map ,train_data['GT'],ker_map)
            ...
            if current_step % opt_P['logger']['save_checkpoint_freq'] == 0:
                if rank <= 0:
                    ...
                    torch.save(model_F.state_dict(), '/home/asfand/Desktop/asfand/medipol/modelF/F_'+str(current_step)+'.pth')
